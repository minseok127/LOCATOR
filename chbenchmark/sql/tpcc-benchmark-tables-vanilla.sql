...
CREATE TABLE DISTRICT (
    ...
    CONSTRAINT DISTRICT_F1 FOREIGN KEY (D_W_ID) REFERENCES WAREHOUSE (W_ID));
...
CREATE TABLE CUSTOMER (
    ...
    CONSTRAINT CUSTOMER_F2 FOREIGN KEY (C_NATIONKEY) REFERENCES NATION (N_NATIONKEY));
...
CREATE TABLE STOCK (
    ...
    CONSTRAINT STOCK_F3 FOREIGN KEY (S_SUPPKEY) REFERENCES SUPPLIER (SU_SUPPKEY));
...
CREATE TABLE ORDERS (
    ...
    CONSTRAINT ORDERS_F1 FOREIGN KEY (O_W_ID, O_D_ID, O_C_ID) REFERENCES CUSTOMER (C_W_ID, C_D_ID, C_ID));
...
CREATE TABLE ORDER_LINE (
    ...
    CONSTRAINT ORDER_LINE_F2 FOREIGN KEY (OL_SUPPLY_W_ID, OL_I_ID) REFERENCES STOCK (S_W_ID, S_I_ID));
