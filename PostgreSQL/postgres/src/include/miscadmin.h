...
#ifdef LSM_TXN
extern PGDLLIMPORT int fdw_relation_id_cnt;
extern PGDLLIMPORT Oid fdw_relation_ids[];
extern PGDLLIMPORT void (*fdw_commit)(int backendId, int relationId);
extern PGDLLIMPORT void (*fdw_abort)(int backendId, int relationId);
#endif /* LSM_TXN */
