...
#ifdef LOCATOR
/* 17: 8 * 2 + 1 */
#define MaxColumnarTuplesPerPage	\
	((int) ((8 * (BLCKSZ - SizeOfPageHeaderData)) / 17))
#endif /* LOCATOR */
...
extern HeapTuple heap_form_tuple(TupleDesc tupleDescriptor,
								 Datum *values, bool *isnull);
#ifdef LOCATOR
extern void fill_columnar_val(Form_pg_attribute att, char *data, Datum datum,
							  bool isnull, bool isAborted);
#endif /* LOCATOR */
