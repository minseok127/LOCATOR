...
typedef struct RelationData
{
	...
	bool rd_locator_partitioning;
	int32 rd_locator_part_count;
	int16 rd_locator_level_count;
	int16 rd_locator_spread_factor;
	uint16 *rd_locator_attrs_maxlen; /* maxlen of all attributes */
#ifdef IO_AMOUNT
