...
typedef enum
{
	...
	WAIT_EVENT_LOCATOR_BGWRITER_MAIN,
#endif
...
#ifdef LOCATOR
	WAIT_EVENT_LEVEL_ZERO_DATA_FILE_READ,
	WAIT_EVENT_LEVEL_ONE_DATA_FILE_READ,
	WAIT_EVENT_LEVEL_TWO_DATA_FILE_READ,
	WAIT_EVENT_LEVEL_THREE_DATA_FILE_READ,
#endif
