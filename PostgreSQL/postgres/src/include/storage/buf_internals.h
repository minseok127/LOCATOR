...
( \
	...
	(a).partLvl = InvalidLocatorPartLevel, \
	(a).partNum = InvalidLocatorPartNumber, \
	(a).partGen = InvalidLocatorPartGenNo, \
...
#define INIT_BUFFERTAG(a,xx_rnode,xx_forkNum,xx_blockNum) \
	(INIT_BUFFERTAG_EXTENDED(a,xx_rnode,xx_forkNum,InvalidLocatorPartLevel,InvalidLocatorPartNumber,InvalidLocatorPartGenNo,xx_blockNum))
...
#ifdef LOCATOR
extern PGDLLIMPORT LWLockPadded *LocatorMempartLocks;
#endif /* LOCATOR */
...
extern BufferDesc *StrategyGetBuffer(BufferAccessStrategy strategy,
									 uint32 *buf_state);
#ifdef LOCATOR
extern BufferDesc *LocatorStrategyGetBuffer(uint32 *buf_state);
extern BufferDesc *LocatorStrategyGetVictimMempartitionBuffer(uint32 *buf_stat);
extern void LocatorStrategyFreeBuffer(BufferDesc *buf);
#endif /* LOCATOR */
