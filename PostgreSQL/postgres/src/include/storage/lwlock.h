...
#ifdef LOCATOR
#define NUM_LOCATOR_EXTERNAL_CATALOG_PARTITIONS (256)
#endif /* LOCATOR */
...
#ifdef LOCATOR
#define LOCATOR_EXTERNAL_CATALOG_MAPPING_LWLOCK_OFFSET   \
	(LOCK_MANAGER_LWLOCK_OFFSET + NUM_LOCK_PARTITIONS)
#define PREDICATELOCK_MANAGER_LWLOCK_OFFSET \
	(LOCATOR_EXTERNAL_CATALOG_MAPPING_LWLOCK_OFFSET + NUM_LOCATOR_EXTERNAL_CATALOG_PARTITIONS)
#else /* LOCATOR */
#define PREDICATELOCK_MANAGER_LWLOCK_OFFSET \
	(LOCK_MANAGER_LWLOCK_OFFSET + NUM_LOCK_PARTITIONS)
#endif /* !LOCATOR */
