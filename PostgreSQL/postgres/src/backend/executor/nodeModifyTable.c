...
/* XXX: hack, only to pass the updated columns to foreignscan */
List *updateColnos_foreignscan;
#endif /* LASER */
...
ExecInitModifyTable(ModifyTable *node, EState *estate, int eflags)
{
...
#ifdef LASER
	/* Set updateColnos_foreignscan to set read_filter of LASER */
	...
	if (operation == CMD_UPDATE)
	{
		for (i = 0; i < nrels; i++)
		{
			...
			{
				updateColnos_foreignscan =
					(List *) list_nth(node->updateColnosLists, i);
				break;
			}
		}
	}
