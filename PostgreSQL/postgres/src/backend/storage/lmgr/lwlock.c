...
static const char *const BuiltinTrancheNames[] = {
	...
	"LockManager",
#ifdef LOCATOR
	/* LWTRANCHE_EXTERNAL_CATALOG_MAPPING: */
	"LocatorExternalCatalogMapping",
...
#ifdef LOCATOR
	/* Initialize external catalog LWLocks in main array */
	lock = MainLWLockArray + LOCATOR_EXTERNAL_CATALOG_MAPPING_LWLOCK_OFFSET;
	for (id = 0; id < NUM_LOCATOR_EXTERNAL_CATALOG_PARTITIONS; id++, lock++)
		LWLockInitialize(&lock->lock, LWTRANCHE_EXTERNAL_CATALOG_MAPPING);
#endif /* LOCATOR */
