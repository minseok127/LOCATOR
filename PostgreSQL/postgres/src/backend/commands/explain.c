			   ...
			   const BufferUsage *bufusage)
{
	...
	if (enable_hap_reduction)
		ExplainPrintHapQueryReductionSummary(es, queryDesc);
#endif /* LOCATOR */
...
#ifdef LOCATOR
/*
 * ExplainPrintHapQueryReductionSummary -
 *    Print summarized query reduction
 */
void
ExplainPrintHapQueryReductionSummary(ExplainState *es, QueryDesc *queryDesc)
{
