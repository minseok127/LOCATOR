...
#ifdef LOCATOR
	/*
	 * In columnar scan, attributes that are not used for update are considered
	 * null. Prevent unnecessary triggers.
	 */
	if (IsLocatorRelId(RelationGetRelid(pk_rel)))
		return false;
#endif /* LOCATOR */
							  ...
							  TupleTableSlot *oldslot, TupleTableSlot *newslot)
{
	 ...
	 * null. Prevent unnecessary triggers.
	 */
	if (IsLocatorRelId(RelationGetRelid(fk_rel)))
		return false;
#endif /* LOCATOR */
