...
#else
/* Default : 8 MiB (page: 4 KiB) */
// int		NPLeafBuffers = 1024 * 1024;
int		NPLeafBuffers = 1024 * 2;
...
#else
/* Default : 64 MiB (page: 8 KiB) */
int		NEbiTreeBuffers = 1024 * 8;
// int		NEbiTreeBuffers = 10 * 10;
int   NEbiSubBuffers = 1024 * 8;
...
#ifdef LSM_TXN
int			fdw_relation_id_cnt = 0;
Oid			fdw_relation_ids[5];
void		(*fdw_commit)(int backendId, int relationId);
void		(*fdw_abort)(int backendId, int relationId);
#endif /* LSM_TXN */
