...
#endif
#ifdef LOCATOR
		case B_LOCATOR_PARTITION_LAUNCHER:
			backendDesc = "locator partition launcher";
			break;
		case B_LOCATOR_PARTITION_WORKER:
			backendDesc = "locator partition worker";
			break;
		case B_LOCATOR_BG_WRITER:
			backendDesc = "locator background writer";
			break;
#endif /* LOCATOR */
		case B_ARCHIVER:
...
InitializeSessionUserIdStandalone(void)
{
	...
	AssertState(!IsUnderPostmaster || IsAutoVacuumWorkerProcess() || 
					IsLocatorPartitionManagerProcess() || IsBackgroundWorker);
#else
