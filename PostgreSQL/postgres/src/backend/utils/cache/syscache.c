...
static const struct cachedesc cacheinfo[] = {
	...
	{HapHiddenAttributeDescRelationId,		/* HAPDESCCONFID */
		...
		3,
		{
			...
			Anum_pg_locator_hap_hidden_attribute_desc_hapconfrelid,
			Anum_pg_locator_hap_hidden_attribute_desc_hapconfdescid,
			0
		},
		32
	},
	{HapHiddenAttributeDescRelationId,		/* HAPDESCRELID */
		...
		{
			Anum_pg_locator_hap_hidden_attribute_desc_haprelid,
			Anum_pg_locator_hap_hidden_attribute_desc_hapdescid,
			0,
			0
		},
		32
	...
	{HapEncodedAttributeRelationId,			/* HAPENCODEDID */
		...
		2,
		{
			...
			Anum_pg_locator_hap_encoded_attribute_hapattrnum,
			0,
			0
		},
		32
	...
	{LocatorRelationId,			/* LOCATORRELID */
		LocatorRelIdIndexId,
		1,
		{
