...
pgstat_get_wait_activity(WaitEventActivity w)
{
	...
	switch (w)
	{
		...
		case WAIT_EVENT_PARTITION_MANAGER_MAIN:
			...
			break;
		case WAIT_EVENT_LOCATOR_BGWRITER_MAIN:
			event_name = "LocatorBgWriterMain";
			break;
#endif
...
pgstat_get_wait_io(WaitEventIO w)
{
	...
	switch (w)
	{
		...
		case WAIT_EVENT_DATA_FILE_READ:
			...
			break;
#ifdef LOCATOR
		case WAIT_EVENT_LEVEL_ZERO_DATA_FILE_READ:
			event_name = "LevelZeroDataFileRead";
			break;
		case WAIT_EVENT_LEVEL_ONE_DATA_FILE_READ:
			event_name = "LevelOneDataFileRead";
			break;
		case WAIT_EVENT_LEVEL_TWO_DATA_FILE_READ:
			event_name = "LevelTwoDataFileRead";
			break;
		case WAIT_EVENT_LEVEL_THREE_DATA_FILE_READ:
			event_name = "LevelThreeDataFileRead";
			break;
#endif
